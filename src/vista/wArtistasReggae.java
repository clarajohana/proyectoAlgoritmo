...
public class wArtistasReggae extends JFrame {
	...
	public wArtistasReggae() {
		...
		lblReggae = new JLabel("Reggae");
		lblReggae.setHorizontalAlignment(SwingConstants.LEFT);
		lblReggae.setForeground(new Color(255, 255, 255));
		lblReggae.setFont(new Font("Calibri", Font.PLAIN, 29));
		lblReggae.setBounds(310, 20, 86, 29);
		contentPane.add(lblReggae);
