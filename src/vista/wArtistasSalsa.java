...
public class wArtistasSalsa extends JFrame {
	...
	public wArtistasSalsa() {
		...
		lblSalsa = new JLabel("Salsa");
		lblSalsa.setForeground(new Color(255, 255, 255));
		lblSalsa.setFont(new Font("Calibri", Font.PLAIN, 29));
		lblSalsa.setBounds(313, 20, 81, 29);
