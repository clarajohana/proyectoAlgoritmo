...
public class wArtistasPop extends JFrame {
	...
	public wArtistasPop() {
		...
		lblPop.setForeground(new Color(255, 255, 255));
		lblPop.setFont(new Font("Calibri", Font.PLAIN, 29));
		lblPop.setBounds(336, 20, 67, 29);
