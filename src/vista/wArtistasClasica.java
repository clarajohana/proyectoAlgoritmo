...
public class wArtistasClasica extends JFrame {
	...
	public wArtistasClasica() {
		...
		lblClasica = new JLabel("Cl\u00E1sica");
		lblClasica.setHorizontalAlignment(SwingConstants.LEFT);
		lblClasica.setForeground(new Color(255, 255, 255));
		lblClasica.setFont(new Font("Calibri", Font.PLAIN, 29));
		lblClasica.setBounds(286, 20, 110, 29);
		contentPane.add(lblClasica);
